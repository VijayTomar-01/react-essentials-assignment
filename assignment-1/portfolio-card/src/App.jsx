...
function App() {
  ...
  return (
    <>
      <div className={`min-h-screen p-4 ${darkTheme ? 'bg-gradient-to-br from-slate-900 via-slate-800 to-black text-gray-100' : 'bg-gradient-to-br from-sky-50 via-white to-indigo-100 text-gray-800'}`}>
