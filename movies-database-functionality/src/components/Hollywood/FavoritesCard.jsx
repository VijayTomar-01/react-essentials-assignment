...
const FavoritesCard = ({title, director, year, genre}) => {
  return (
    <div className="bg-[linear-gradient(rgba(0,0,0,0.6),rgba(0,0,0,0.7)),url('https://png.pngtree.com/thumb_back/fw800/background/20230718/pngtree-cinematic-essentials-clapperboard-film-reel-popcorn-and-3d-glasses-on-a-image_3905897.jpg')] bg-cover bg-center p-4 mt-6 border-2 border-cyan-300 flex flex-col items-center justify-center shadow-lg shadow-gray-500 rounded-xl transition-all duration-300 hover:scale-105">
        ...
        <div className='flex items-center justify-center gap-4 mx-6 mb-3'>
          {genre.map(g => (
